...
NV_STATUS __nvoc_ctor_MemoryFabricImportedRef(MemoryFabricImportedRef*, CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams);
...
// Class-specific details for MemoryFabricImportedRef
const struct NVOC_CLASS_DEF __nvoc_class_def_MemoryFabricImportedRef = 
{
    .classInfo.size =               sizeof(MemoryFabricImportedRef),
    .classInfo.classId =            classId(MemoryFabricImportedRef),
    .classInfo.providerId =         &__nvoc_rtti_provider,
#if NV_PRINTF_STRINGS_ALLOWED
    .classInfo.name =               "MemoryFabricImportedRef",
#endif
...
// Destruct MemoryFabricImportedRef object.
void __nvoc_memoryfabricimportedrefDestruct(MemoryFabricImportedRef*);
...
// Construct MemoryFabricImportedRef object.
...
NV_STATUS __nvoc_ctor_MemoryFabricImportedRef(MemoryFabricImportedRef *pMemoryFabricImportedRef, CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams) {    // inline
    NV_STATUS status = NV_OK;

    // Recurse to ancestor constructor(s).
    status = __nvoc_ctor_RmResource(&pMemoryFabricImportedRef->__nvoc_base_RmResource, pCallContext, pParams);
    if (status != NV_OK) goto __nvoc_ctor_MemoryFabricImportedRef_fail_RmResource;

    // Initialize data fields.
    __nvoc_init_dataField_MemoryFabricImportedRef(pMemoryFabricImportedRef);

    // Call the constructor for this class.
    status = __nvoc_memoryfabricimportedrefConstruct(pMemoryFabricImportedRef, pCallContext, pParams);
...
__nvoc_ctor_MemoryFabricImportedRef_fail__init:
    __nvoc_dtor_RmResource(&pMemoryFabricImportedRef->__nvoc_base_RmResource);
...
static void __nvoc_init_funcTable_MemoryFabricImportedRef_1(MemoryFabricImportedRef *pThis) {
    PORT_UNREFERENCED_VARIABLE(pThis);
} // End __nvoc_init_funcTable_MemoryFabricImportedRef_1
...
NV_STATUS __nvoc_objCreate_MemoryFabricImportedRef(MemoryFabricImportedRef **__nvoc_ppThis, Dynamic *__nvoc_pParent, NvU32 __nvoc_createFlags, CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams)
{
    NV_STATUS __nvoc_status;
    Object *__nvoc_pParentObj = NULL;
    MemoryFabricImportedRef *__nvoc_pThis;
    ...
    {
        __nvoc_pThis = portMemAllocNonPaged(sizeof(MemoryFabricImportedRef));
        NV_CHECK_OR_RETURN(LEVEL_ERROR, __nvoc_pThis != NULL, NV_ERR_NO_MEMORY);
    }

    // Zero is the initial value for everything.
    portMemSet(__nvoc_pThis, 0, sizeof(MemoryFabricImportedRef));
    ...
    __nvoc_init__MemoryFabricImportedRef(__nvoc_pThis);
    __nvoc_status = __nvoc_ctor_MemoryFabricImportedRef(__nvoc_pThis, pCallContext, pParams);
    if (__nvoc_status != NV_OK) goto __nvoc_objCreate_MemoryFabricImportedRef_cleanup;
...
NV_STATUS __nvoc_objCreateDynamic_MemoryFabricImportedRef(MemoryFabricImportedRef **__nvoc_ppThis, Dynamic *__nvoc_pParent, NvU32 __nvoc_createFlags, va_list __nvoc_args) {
    NV_STATUS __nvoc_status;
    CALL_CONTEXT *pCallContext = va_arg(__nvoc_args, CALL_CONTEXT *);
    struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams = va_arg(__nvoc_args, struct RS_RES_ALLOC_PARAMS_INTERNAL *);

    __nvoc_status = __nvoc_objCreate_MemoryFabricImportedRef(__nvoc_ppThis, __nvoc_pParent, __nvoc_createFlags, pCallContext, pParams);
