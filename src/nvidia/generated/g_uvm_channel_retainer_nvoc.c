...
// Class-specific details for UvmChannelRetainer
const struct NVOC_CLASS_DEF __nvoc_class_def_UvmChannelRetainer = 
{
    .classInfo.size =               sizeof(UvmChannelRetainer),
    .classInfo.classId =            classId(UvmChannelRetainer),
...
// Construct UvmChannelRetainer object.
...
NV_STATUS __nvoc_ctor_UvmChannelRetainer(UvmChannelRetainer *pUvmChannelRetainer, RmHalspecOwner *pRmhalspecowner, CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams) {    // inline
    NV_STATUS status = NV_OK;

    // Recurse to ancestor constructor(s).
    status = __nvoc_ctor_GpuResource(&pUvmChannelRetainer->__nvoc_base_GpuResource, pCallContext, pParams);
    if (status != NV_OK) goto __nvoc_ctor_UvmChannelRetainer_fail_GpuResource;

    // Initialize data fields.
    __nvoc_init_dataField_UvmChannelRetainer(pUvmChannelRetainer, pRmhalspecowner);

    // Call the constructor for this class.
    status = __nvoc_uvmchanrtnrConstruct(pUvmChannelRetainer, pCallContext, pParams);
...
NV_STATUS __nvoc_objCreate_UvmChannelRetainer(UvmChannelRetainer **__nvoc_ppThis, Dynamic *__nvoc_pParent, NvU32 __nvoc_createFlags, CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams)
{
    NV_STATUS __nvoc_status;
    Object *__nvoc_pParentObj = NULL;
    UvmChannelRetainer *__nvoc_pThis;
    ...
    {
        __nvoc_pThis = portMemAllocNonPaged(sizeof(UvmChannelRetainer));
        NV_CHECK_OR_RETURN(LEVEL_ERROR, __nvoc_pThis != NULL, NV_ERR_NO_MEMORY);
    }

    // Zero is the initial value for everything.
    portMemSet(__nvoc_pThis, 0, sizeof(UvmChannelRetainer));
    ...
    NV_CHECK_TRUE_OR_GOTO(__nvoc_status, LEVEL_ERROR, __nvoc_pParent != NULL, NV_ERR_INVALID_ARGUMENT, __nvoc_objCreate_UvmChannelRetainer_cleanup);
    ...
    NV_CHECK_TRUE_OR_GOTO(__nvoc_status, LEVEL_ERROR, pRmhalspecowner != NULL, NV_ERR_INVALID_ARGUMENT, __nvoc_objCreate_UvmChannelRetainer_cleanup);

    // Initialize vtable, RTTI, etc., then call constructor.
    __nvoc_init__UvmChannelRetainer(__nvoc_pThis, pRmhalspecowner);
    __nvoc_status = __nvoc_ctor_UvmChannelRetainer(__nvoc_pThis, pRmhalspecowner, pCallContext, pParams);
    if (__nvoc_status != NV_OK) goto __nvoc_objCreate_UvmChannelRetainer_cleanup;
