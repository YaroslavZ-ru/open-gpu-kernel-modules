...
void __nvoc_init__KernelMc(KernelMc*, GpuHalspecOwner *pGpuhalspecowner);
...
// Class-specific details for KernelMc
const struct NVOC_CLASS_DEF __nvoc_class_def_KernelMc = 
{
    .classInfo.size =               sizeof(KernelMc),
    .classInfo.classId =            classId(KernelMc),
...
// Construct KernelMc object.
NV_STATUS __nvoc_ctor_OBJENGSTATE(OBJENGSTATE *);
NV_STATUS __nvoc_ctor_KernelMc(KernelMc *pThis, GpuHalspecOwner *pGpuhalspecowner) {
    ...
    __nvoc_init_dataField_KernelMc(pThis, pGpuhalspecowner);
...
static void __nvoc_init_funcTable_KernelMc_1(KernelMc *pThis, GpuHalspecOwner *pGpuhalspecowner) {
    ChipHal *chipHal = &pGpuhalspecowner->chipHal;
    const unsigned long chipHal_HalVarIdx = (unsigned long)chipHal->__nvoc_HalVarIdx;
    PORT_UNREFERENCED_VARIABLE(pThis);
    PORT_UNREFERENCED_VARIABLE(pGpuhalspecowner);
    ...
    {
        pThis->__kmcPrepareForXVEReset__ = &kmcPrepareForXVEReset_GM107;
    }
    ...
    {
        pThis->__kmcGetMcBar0MapInfo__ = &kmcGetMcBar0MapInfo_GM107;
    }
    else
    {
        pThis->__kmcGetMcBar0MapInfo__ = &kmcGetMcBar0MapInfo_GB100;
    }

    // kmcReadPmcBoot0 -- halified (3 hals) body
    ...
    {
        pThis->__kmcReadPmcBoot0__ = &kmcReadPmcBoot0_b2b553;
    }
} // End __nvoc_init_funcTable_KernelMc_1 with approximately 11 basic block(s).


// Initialize vtable(s) for 18 virtual method(s).
void __nvoc_init_funcTable_KernelMc(KernelMc *pThis, GpuHalspecOwner *pGpuhalspecowner) {

    // Initialize vtable(s) with 4 per-object function pointer(s).
    __nvoc_init_funcTable_KernelMc_1(pThis, pGpuhalspecowner);
}

// Initialize newly constructed object.
void __nvoc_init__KernelMc(KernelMc *pThis, GpuHalspecOwner *pGpuhalspecowner) {
    ...
    __nvoc_init_funcTable_KernelMc(pThis, pGpuhalspecowner);
}

NV_STATUS __nvoc_objCreate_KernelMc(KernelMc **__nvoc_ppThis, Dynamic *__nvoc_pParent, NvU32 __nvoc_createFlags)
{
    NV_STATUS __nvoc_status;
    Object *__nvoc_pParentObj = NULL;
    KernelMc *__nvoc_pThis;
    ...
    {
        __nvoc_pThis = portMemAllocNonPaged(sizeof(KernelMc));
        NV_CHECK_OR_RETURN(LEVEL_ERROR, __nvoc_pThis != NULL, NV_ERR_NO_MEMORY);
    }

    // Zero is the initial value for everything.
    portMemSet(__nvoc_pThis, 0, sizeof(KernelMc));

    __nvoc_pThis->__nvoc_base_OBJENGSTATE.__nvoc_base_Object.createFlags = __nvoc_createFlags;

    // pParent must be a valid object that derives from a halspec owner class.
    NV_CHECK_TRUE_OR_GOTO(__nvoc_status, LEVEL_ERROR, __nvoc_pParent != NULL, NV_ERR_INVALID_ARGUMENT, __nvoc_objCreate_KernelMc_cleanup);
    ...
    NV_CHECK_TRUE_OR_GOTO(__nvoc_status, LEVEL_ERROR, pGpuhalspecowner != NULL, NV_ERR_INVALID_ARGUMENT, __nvoc_objCreate_KernelMc_cleanup);

    // Initialize vtable, RTTI, etc., then call constructor.
    __nvoc_init__KernelMc(__nvoc_pThis, pGpuhalspecowner);
    __nvoc_status = __nvoc_ctor_KernelMc(__nvoc_pThis, pGpuhalspecowner);
    if (__nvoc_status != NV_OK) goto __nvoc_objCreate_KernelMc_cleanup;
