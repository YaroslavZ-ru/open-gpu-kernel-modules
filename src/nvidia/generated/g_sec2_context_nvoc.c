...
NV_STATUS __nvoc_ctor_Sec2Context(Sec2Context*, RmHalspecOwner *pRmhalspecowner, struct CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams);
...
// Class-specific details for Sec2Context
const struct NVOC_CLASS_DEF __nvoc_class_def_Sec2Context = 
{
    .classInfo.size =               sizeof(Sec2Context),
    .classInfo.classId =            classId(Sec2Context),
    .classInfo.providerId =         &__nvoc_rtti_provider,
#if NV_PRINTF_STRINGS_ALLOWED
    .classInfo.name =               "Sec2Context",
#endif
...
// Destruct Sec2Context object.
void __nvoc_sec2ctxDestruct(Sec2Context*);
...
NV_STATUS __nvoc_ctor_Sec2Context(Sec2Context *pSec2Context, RmHalspecOwner *pRmhalspecowner, struct CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams) {    // inline body
    NV_STATUS status = NV_OK;

    // Recurse to ancestor constructor(s).
    status = __nvoc_ctor_ChannelDescendant(&pSec2Context->__nvoc_base_ChannelDescendant, pRmhalspecowner, pCallContext, pParams, ((void *)0));
    if (status != NV_OK) goto __nvoc_ctor_Sec2Context_fail_ChannelDescendant;

    // Initialize data fields.
    __nvoc_init_dataField_Sec2Context(pSec2Context, pRmhalspecowner);

    // Call the constructor for this class.
    status = __nvoc_sec2ctxConstruct(pSec2Context, pCallContext, pParams);
...
__nvoc_ctor_Sec2Context_fail__init:
    __nvoc_dtor_ChannelDescendant(&pSec2Context->__nvoc_base_ChannelDescendant);
...
NV_STATUS __nvoc_objCreate_Sec2Context(Sec2Context **__nvoc_ppThis, Dynamic *__nvoc_pParent, NvU32 __nvoc_createFlags, struct CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams)
{
    NV_STATUS __nvoc_status;
    Object *__nvoc_pParentObj = NULL;
    Sec2Context *__nvoc_pThis;
    ...
    {
        __nvoc_pThis = portMemAllocNonPaged(sizeof(Sec2Context));
        NV_CHECK_OR_RETURN(LEVEL_ERROR, __nvoc_pThis != NULL, NV_ERR_NO_MEMORY);
    }

    // Zero is the initial value for everything.
    portMemSet(__nvoc_pThis, 0, sizeof(Sec2Context));
    ...
    NV_CHECK_TRUE_OR_GOTO(__nvoc_status, LEVEL_ERROR, __nvoc_pParent != NULL, NV_ERR_INVALID_ARGUMENT, __nvoc_objCreate_Sec2Context_cleanup);
    ...
    NV_CHECK_TRUE_OR_GOTO(__nvoc_status, LEVEL_ERROR, pRmhalspecowner != NULL, NV_ERR_INVALID_ARGUMENT, __nvoc_objCreate_Sec2Context_cleanup);

    // Initialize vtable, RTTI, etc., then call constructor.
    __nvoc_init__Sec2Context(__nvoc_pThis, pRmhalspecowner);
    __nvoc_status = __nvoc_ctor_Sec2Context(__nvoc_pThis, pRmhalspecowner, pCallContext, pParams);
    if (__nvoc_status != NV_OK) goto __nvoc_objCreate_Sec2Context_cleanup;
...
NV_STATUS __nvoc_objCreateDynamic_Sec2Context(Sec2Context **__nvoc_ppThis, Dynamic *__nvoc_pParent, NvU32 __nvoc_createFlags, va_list __nvoc_args) {
    NV_STATUS __nvoc_status;
    struct CALL_CONTEXT *pCallContext = va_arg(__nvoc_args, struct CALL_CONTEXT *);
    struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams = va_arg(__nvoc_args, struct RS_RES_ALLOC_PARAMS_INTERNAL *);

    __nvoc_status = __nvoc_objCreate_Sec2Context(__nvoc_ppThis, __nvoc_pParent, __nvoc_createFlags, pCallContext, pParams);
