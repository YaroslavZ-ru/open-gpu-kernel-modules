...
// Forward declarations for NvencSession
void __nvoc_init__GpuResource(GpuResource*);
void __nvoc_init__NvencSession(NvencSession*);
...
extern const struct NVOC_EXPORT_INFO __nvoc_export_info__NvencSession;
...
// Class-specific details for NvencSession
const struct NVOC_CLASS_DEF __nvoc_class_def_NvencSession = 
{
    .classInfo.size =               sizeof(NvencSession),
    .classInfo.classId =            classId(NvencSession),
...
static const struct NVOC_METADATA__NvencSession __nvoc_metadata__NvencSession = {
    ...
    .metadata__GpuResource.rtti.offset    = NV_OFFSETOF(NvencSession, __nvoc_base_GpuResource),
    ...
    .metadata__GpuResource.metadata__RmResource.rtti.offset    = NV_OFFSETOF(NvencSession, __nvoc_base_GpuResource.__nvoc_base_RmResource),
    ...
    .metadata__GpuResource.metadata__RmResource.metadata__RsResource.rtti.offset    = NV_OFFSETOF(NvencSession, __nvoc_base_GpuResource.__nvoc_base_RmResource.__nvoc_base_RsResource),
    ...
    .metadata__GpuResource.metadata__RmResource.metadata__RsResource.metadata__Object.rtti.offset    = NV_OFFSETOF(NvencSession, __nvoc_base_GpuResource.__nvoc_base_RmResource.__nvoc_base_RsResource.__nvoc_base_Object),
    ...
    .metadata__GpuResource.metadata__RmResource.metadata__RmResourceCommon.rtti.offset    = NV_OFFSETOF(NvencSession, __nvoc_base_GpuResource.__nvoc_base_RmResource.__nvoc_base_RmResourceCommon),

    .vtable.__nvencsessionControl__ = &__nvoc_up_thunk_GpuResource_nvencsessionControl,    // virtual inherited (gpures) base (gpures)
    ...
    .vtable.__nvencsessionMap__ = &__nvoc_up_thunk_GpuResource_nvencsessionMap,    // virtual inherited (gpures) base (gpures)
    ...
    .vtable.__nvencsessionUnmap__ = &__nvoc_up_thunk_GpuResource_nvencsessionUnmap,    // virtual inherited (gpures) base (gpures)
    ...
    .vtable.__nvencsessionShareCallback__ = &__nvoc_up_thunk_GpuResource_nvencsessionShareCallback,    // virtual inherited (gpures) base (gpures)
    ...
    .vtable.__nvencsessionGetRegBaseOffsetAndSize__ = &__nvoc_up_thunk_GpuResource_nvencsessionGetRegBaseOffsetAndSize,    // virtual inherited (gpures) base (gpures)
    .metadata__GpuResource.vtable.__gpuresGetRegBaseOffsetAndSize__ = &gpuresGetRegBaseOffsetAndSize_IMPL,    // virtual
    .vtable.__nvencsessionGetMapAddrSpace__ = &__nvoc_up_thunk_GpuResource_nvencsessionGetMapAddrSpace,    // virtual inherited (gpures) base (gpures)
    .metadata__GpuResource.vtable.__gpuresGetMapAddrSpace__ = &gpuresGetMapAddrSpace_IMPL,    // virtual
    .vtable.__nvencsessionInternalControlForward__ = &__nvoc_up_thunk_GpuResource_nvencsessionInternalControlForward,    // virtual inherited (gpures) base (gpures)
    .metadata__GpuResource.vtable.__gpuresInternalControlForward__ = &gpuresInternalControlForward_IMPL,    // virtual
    .vtable.__nvencsessionGetInternalObjectHandle__ = &__nvoc_up_thunk_GpuResource_nvencsessionGetInternalObjectHandle,    // virtual inherited (gpures) base (gpures)
    .metadata__GpuResource.vtable.__gpuresGetInternalObjectHandle__ = &gpuresGetInternalObjectHandle_IMPL,    // virtual
    .vtable.__nvencsessionAccessCallback__ = &__nvoc_up_thunk_RmResource_nvencsessionAccessCallback,    // virtual inherited (rmres) base (gpures)
    ...
    .vtable.__nvencsessionGetMemInterMapParams__ = &__nvoc_up_thunk_RmResource_nvencsessionGetMemInterMapParams,    // virtual inherited (rmres) base (gpures)
    ...
    .vtable.__nvencsessionCheckMemInterUnmap__ = &__nvoc_up_thunk_RmResource_nvencsessionCheckMemInterUnmap,    // virtual inherited (rmres) base (gpures)
    ...
    .vtable.__nvencsessionGetMemoryMappingDescriptor__ = &__nvoc_up_thunk_RmResource_nvencsessionGetMemoryMappingDescriptor,    // virtual inherited (rmres) base (gpures)
    ...
    .vtable.__nvencsessionControlSerialization_Prologue__ = &__nvoc_up_thunk_RmResource_nvencsessionControlSerialization_Prologue,    // virtual inherited (rmres) base (gpures)
    ...
    .vtable.__nvencsessionControlSerialization_Epilogue__ = &__nvoc_up_thunk_RmResource_nvencsessionControlSerialization_Epilogue,    // virtual inherited (rmres) base (gpures)
    ...
    .vtable.__nvencsessionControl_Prologue__ = &__nvoc_up_thunk_RmResource_nvencsessionControl_Prologue,    // virtual inherited (rmres) base (gpures)
    ...
    .vtable.__nvencsessionControl_Epilogue__ = &__nvoc_up_thunk_RmResource_nvencsessionControl_Epilogue,    // virtual inherited (rmres) base (gpures)
    ...
    .vtable.__nvencsessionCanCopy__ = &__nvoc_up_thunk_RsResource_nvencsessionCanCopy,    // virtual inherited (res) base (gpures)
    ...
    .vtable.__nvencsessionIsDuplicate__ = &__nvoc_up_thunk_RsResource_nvencsessionIsDuplicate,    // virtual inherited (res) base (gpures)
    ...
    .vtable.__nvencsessionPreDestruct__ = &__nvoc_up_thunk_RsResource_nvencsessionPreDestruct,    // virtual inherited (res) base (gpures)
    ...
    .vtable.__nvencsessionControlFilter__ = &__nvoc_up_thunk_RsResource_nvencsessionControlFilter,    // virtual inherited (res) base (gpures)
    ...
    .vtable.__nvencsessionIsPartialUnmapSupported__ = &__nvoc_up_thunk_RsResource_nvencsessionIsPartialUnmapSupported,    // inline virtual inherited (res) base (gpures) body
    ...
    .vtable.__nvencsessionMapTo__ = &__nvoc_up_thunk_RsResource_nvencsessionMapTo,    // virtual inherited (res) base (gpures)
    ...
    .vtable.__nvencsessionUnmapFrom__ = &__nvoc_up_thunk_RsResource_nvencsessionUnmapFrom,    // virtual inherited (res) base (gpures)
    ...
    .vtable.__nvencsessionGetRefCount__ = &__nvoc_up_thunk_RsResource_nvencsessionGetRefCount,    // virtual inherited (res) base (gpures)
    ...
    .vtable.__nvencsessionAddAdditionalDependants__ = &__nvoc_up_thunk_RsResource_nvencsessionAddAdditionalDependants,    // virtual inherited (res) base (gpures)
...
const struct NVOC_CASTINFO __nvoc_castinfo__NvencSession = {
    .numRelatives = 6,
    .relatives = {
        &__nvoc_metadata__NvencSession.rtti,    // [0]: (nvencsession) this
        &__nvoc_metadata__NvencSession.metadata__GpuResource.rtti,    // [1]: (gpures) super
        &__nvoc_metadata__NvencSession.metadata__GpuResource.metadata__RmResource.rtti,    // [2]: (rmres) super^2
        &__nvoc_metadata__NvencSession.metadata__GpuResource.metadata__RmResource.metadata__RsResource.rtti,    // [3]: (res) super^3
        &__nvoc_metadata__NvencSession.metadata__GpuResource.metadata__RmResource.metadata__RsResource.metadata__Object.rtti,    // [4]: (obj) super^4
        &__nvoc_metadata__NvencSession.metadata__GpuResource.metadata__RmResource.metadata__RmResourceCommon.rtti,    // [5]: (rmrescmn) super^3
    }
};
...
const struct NVOC_EXPORT_INFO __nvoc_export_info__NvencSession = 
{
    .numEntries=     2,
...
NV_STATUS __nvoc_ctor_NvencSession(NvencSession *pNvencSession, struct CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams) {    // inline
    NV_STATUS status = NV_OK;

    // Recurse to ancestor constructor(s).
    status = __nvoc_ctor_GpuResource(&pNvencSession->__nvoc_base_GpuResource, pCallContext, pParams);
    if (status != NV_OK) goto __nvoc_ctor_NvencSession_fail_GpuResource;

    // Initialize data fields.
    __nvoc_init_dataField_NvencSession(pNvencSession);

    // Call the constructor for this class.
    status = __nvoc_nvencsessionConstruct(pNvencSession, pCallContext, pParams);
...
void __nvoc_init__NvencSession(NvencSession *pThis) {
    ...
    pThis->__nvoc_pbase_NvencSession = pThis;    // (nvencsession) this

    // Recurse to superclass initialization function(s).
    __nvoc_init__GpuResource(&pThis->__nvoc_base_GpuResource);

    // Pointer(s) to metadata structures(s)
    pThis->__nvoc_base_GpuResource.__nvoc_base_RmResource.__nvoc_base_RsResource.__nvoc_base_Object.__nvoc_metadata_ptr = &__nvoc_metadata__NvencSession.metadata__GpuResource.metadata__RmResource.metadata__RsResource.metadata__Object;    // (obj) super^4
    pThis->__nvoc_base_GpuResource.__nvoc_base_RmResource.__nvoc_base_RsResource.__nvoc_metadata_ptr = &__nvoc_metadata__NvencSession.metadata__GpuResource.metadata__RmResource.metadata__RsResource;    // (res) super^3
    pThis->__nvoc_base_GpuResource.__nvoc_base_RmResource.__nvoc_base_RmResourceCommon.__nvoc_metadata_ptr = &__nvoc_metadata__NvencSession.metadata__GpuResource.metadata__RmResource.metadata__RmResourceCommon;    // (rmrescmn) super^3
    pThis->__nvoc_base_GpuResource.__nvoc_base_RmResource.__nvoc_metadata_ptr = &__nvoc_metadata__NvencSession.metadata__GpuResource.metadata__RmResource;    // (rmres) super^2
    pThis->__nvoc_base_GpuResource.__nvoc_metadata_ptr = &__nvoc_metadata__NvencSession.metadata__GpuResource;    // (gpures) super
    pThis->__nvoc_metadata_ptr = &__nvoc_metadata__NvencSession;    // (nvencsession) this

    // Initialize per-object vtables.
    __nvoc_init_funcTable_NvencSession(pThis);
}

NV_STATUS __nvoc_objCreate_NvencSession(NvencSession **__nvoc_ppThis, Dynamic *__nvoc_pParent, NvU32 __nvoc_createFlags, struct CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams)
{
    NV_STATUS __nvoc_status;
    Object *__nvoc_pParentObj = NULL;
    NvencSession *__nvoc_pThis;
    ...
    {
        __nvoc_pThis = portMemAllocNonPaged(sizeof(NvencSession));
        NV_CHECK_OR_RETURN(LEVEL_ERROR, __nvoc_pThis != NULL, NV_ERR_NO_MEMORY);
    }

    // Zero is the initial value for everything.
    portMemSet(__nvoc_pThis, 0, sizeof(NvencSession));
    ...
    __nvoc_init__NvencSession(__nvoc_pThis);
    __nvoc_status = __nvoc_ctor_NvencSession(__nvoc_pThis, pCallContext, pParams);
    if (__nvoc_status != NV_OK) goto __nvoc_objCreate_NvencSession_cleanup;
