...
// Class-specific details for OBJPFM
const struct NVOC_CLASS_DEF __nvoc_class_def_OBJPFM = 
{
    .classInfo.size =               sizeof(OBJPFM),
    .classInfo.classId =            classId(OBJPFM),
    .classInfo.providerId =         &__nvoc_rtti_provider,
#if NV_PRINTF_STRINGS_ALLOWED
    .classInfo.name =               "OBJPFM",
#endif
...
// Construct OBJPFM object.
NV_STATUS __nvoc_ctor_Object(Object *);
NV_STATUS __nvoc_ctor_OBJPFM(OBJPFM *pPfm) {
    NV_STATUS status = NV_OK;

    // Recurse to ancestor constructor(s).
    status = __nvoc_ctor_Object(&pPfm->__nvoc_base_Object);
    if (status != NV_OK) goto __nvoc_ctor_OBJPFM_fail_Object;

    // Initialize data fields.
    __nvoc_init_dataField_OBJPFM(pPfm);

    // Call the constructor for this class.
    status = __nvoc_pfmConstruct(pPfm);
    if (status != NV_OK) goto __nvoc_ctor_OBJPFM_fail__init;
    goto __nvoc_ctor_OBJPFM_exit; // Success

    // Unwind on error.
__nvoc_ctor_OBJPFM_fail__init:
    __nvoc_dtor_Object(&pPfm->__nvoc_base_Object);
...
NV_STATUS __nvoc_objCreate_OBJPFM(OBJPFM **__nvoc_ppThis, Dynamic *__nvoc_pParent, NvU32 __nvoc_createFlags)
{
    ...
    {
        __nvoc_pThis = portMemAllocNonPaged(sizeof(OBJPFM));
        NV_CHECK_OR_RETURN(LEVEL_ERROR, __nvoc_pThis != NULL, NV_ERR_NO_MEMORY);
    }

    // Zero is the initial value for everything.
    portMemSet(__nvoc_pThis, 0, sizeof(OBJPFM));
    ...
    __nvoc_init__OBJPFM(__nvoc_pThis);
    __nvoc_status = __nvoc_ctor_OBJPFM(__nvoc_pThis);
    if (__nvoc_status != NV_OK) goto __nvoc_objCreate_OBJPFM_cleanup;
...
NV_STATUS __nvoc_objCreateDynamic_OBJPFM(OBJPFM **__nvoc_ppThis, Dynamic *__nvoc_pParent, NvU32 __nvoc_createFlags, va_list __nvoc_args) {
    NV_STATUS __nvoc_status;

    __nvoc_status = __nvoc_objCreate_OBJPFM(__nvoc_ppThis, __nvoc_pParent, __nvoc_createFlags);
