...
NV_STATUS __nvoc_ctor_MemoryList(MemoryList*, CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams);
...
// Class-specific details for MemoryList
const struct NVOC_CLASS_DEF __nvoc_class_def_MemoryList = 
{
    .classInfo.size =               sizeof(MemoryList),
    .classInfo.classId =            classId(MemoryList),
    .classInfo.providerId =         &__nvoc_rtti_provider,
#if NV_PRINTF_STRINGS_ALLOWED
    .classInfo.name =               "MemoryList",
#endif
...
// Construct MemoryList object.
NV_STATUS __nvoc_ctor_Memory(Memory *pMemory, CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams);    // inline
NV_STATUS __nvoc_ctor_MemoryList(MemoryList *pMemoryList, CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams) {    // inline
    NV_STATUS status = NV_OK;

    // Recurse to ancestor constructor(s).
    status = __nvoc_ctor_Memory(&pMemoryList->__nvoc_base_Memory, pCallContext, pParams);
    if (status != NV_OK) goto __nvoc_ctor_MemoryList_fail_Memory;

    // Initialize data fields.
    __nvoc_init_dataField_MemoryList(pMemoryList);

    // Call the constructor for this class.
    status = __nvoc_memlistConstruct(pMemoryList, pCallContext, pParams);
...
__nvoc_ctor_MemoryList_fail__init:
    __nvoc_dtor_Memory(&pMemoryList->__nvoc_base_Memory);
...
NV_STATUS __nvoc_objCreate_MemoryList(MemoryList **__nvoc_ppThis, Dynamic *__nvoc_pParent, NvU32 __nvoc_createFlags, CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams)
{
    NV_STATUS __nvoc_status;
    Object *__nvoc_pParentObj = NULL;
    MemoryList *__nvoc_pThis;
    ...
    {
        __nvoc_pThis = portMemAllocNonPaged(sizeof(MemoryList));
        NV_CHECK_OR_RETURN(LEVEL_ERROR, __nvoc_pThis != NULL, NV_ERR_NO_MEMORY);
    }

    // Zero is the initial value for everything.
    portMemSet(__nvoc_pThis, 0, sizeof(MemoryList));
    ...
    __nvoc_init__MemoryList(__nvoc_pThis);
    __nvoc_status = __nvoc_ctor_MemoryList(__nvoc_pThis, pCallContext, pParams);
    if (__nvoc_status != NV_OK) goto __nvoc_objCreate_MemoryList_cleanup;
...
NV_STATUS __nvoc_objCreateDynamic_MemoryList(MemoryList **__nvoc_ppThis, Dynamic *__nvoc_pParent, NvU32 __nvoc_createFlags, va_list __nvoc_args) {
    NV_STATUS __nvoc_status;
    CALL_CONTEXT *pCallContext = va_arg(__nvoc_args, CALL_CONTEXT *);
    struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams = va_arg(__nvoc_args, struct RS_RES_ALLOC_PARAMS_INTERNAL *);

    __nvoc_status = __nvoc_objCreate_MemoryList(__nvoc_ppThis, __nvoc_pParent, __nvoc_createFlags, pCallContext, pParams);
