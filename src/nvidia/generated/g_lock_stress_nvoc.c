...
// Forward declarations for LockStressObject
...
extern const struct NVOC_EXPORT_INFO __nvoc_export_info__LockStressObject;
...
static const struct NVOC_METADATA__LockStressObject __nvoc_metadata__LockStressObject = {
    ...
    .metadata__GpuResource.rtti.offset    = NV_OFFSETOF(LockStressObject, __nvoc_base_GpuResource),
    ...
    .metadata__GpuResource.metadata__RmResource.rtti.offset    = NV_OFFSETOF(LockStressObject, __nvoc_base_GpuResource.__nvoc_base_RmResource),
    ...
    .metadata__GpuResource.metadata__RmResource.metadata__RsResource.rtti.offset    = NV_OFFSETOF(LockStressObject, __nvoc_base_GpuResource.__nvoc_base_RmResource.__nvoc_base_RsResource),
    ...
    .metadata__GpuResource.metadata__RmResource.metadata__RsResource.metadata__Object.rtti.offset    = NV_OFFSETOF(LockStressObject, __nvoc_base_GpuResource.__nvoc_base_RmResource.__nvoc_base_RsResource.__nvoc_base_Object),
    ...
    .metadata__GpuResource.metadata__RmResource.metadata__RmResourceCommon.rtti.offset    = NV_OFFSETOF(LockStressObject, __nvoc_base_GpuResource.__nvoc_base_RmResource.__nvoc_base_RmResourceCommon),

    .vtable.__lockStressObjControl__ = &__nvoc_up_thunk_GpuResource_lockStressObjControl,    // virtual inherited (gpures) base (gpures)
    ...
    .vtable.__lockStressObjMap__ = &__nvoc_up_thunk_GpuResource_lockStressObjMap,    // virtual inherited (gpures) base (gpures)
    ...
    .vtable.__lockStressObjUnmap__ = &__nvoc_up_thunk_GpuResource_lockStressObjUnmap,    // virtual inherited (gpures) base (gpures)
    ...
    .vtable.__lockStressObjShareCallback__ = &__nvoc_up_thunk_GpuResource_lockStressObjShareCallback,    // virtual inherited (gpures) base (gpures)
    ...
    .vtable.__lockStressObjGetRegBaseOffsetAndSize__ = &__nvoc_up_thunk_GpuResource_lockStressObjGetRegBaseOffsetAndSize,    // virtual inherited (gpures) base (gpures)
    .metadata__GpuResource.vtable.__gpuresGetRegBaseOffsetAndSize__ = &gpuresGetRegBaseOffsetAndSize_IMPL,    // virtual
    .vtable.__lockStressObjGetMapAddrSpace__ = &__nvoc_up_thunk_GpuResource_lockStressObjGetMapAddrSpace,    // virtual inherited (gpures) base (gpures)
    .metadata__GpuResource.vtable.__gpuresGetMapAddrSpace__ = &gpuresGetMapAddrSpace_IMPL,    // virtual
    .vtable.__lockStressObjInternalControlForward__ = &__nvoc_up_thunk_GpuResource_lockStressObjInternalControlForward,    // virtual inherited (gpures) base (gpures)
    .metadata__GpuResource.vtable.__gpuresInternalControlForward__ = &gpuresInternalControlForward_IMPL,    // virtual
    .vtable.__lockStressObjGetInternalObjectHandle__ = &__nvoc_up_thunk_GpuResource_lockStressObjGetInternalObjectHandle,    // virtual inherited (gpures) base (gpures)
    .metadata__GpuResource.vtable.__gpuresGetInternalObjectHandle__ = &gpuresGetInternalObjectHandle_IMPL,    // virtual
    .vtable.__lockStressObjAccessCallback__ = &__nvoc_up_thunk_RmResource_lockStressObjAccessCallback,    // virtual inherited (rmres) base (gpures)
    ...
    .vtable.__lockStressObjGetMemInterMapParams__ = &__nvoc_up_thunk_RmResource_lockStressObjGetMemInterMapParams,    // virtual inherited (rmres) base (gpures)
    ...
    .vtable.__lockStressObjCheckMemInterUnmap__ = &__nvoc_up_thunk_RmResource_lockStressObjCheckMemInterUnmap,    // virtual inherited (rmres) base (gpures)
    ...
    .vtable.__lockStressObjGetMemoryMappingDescriptor__ = &__nvoc_up_thunk_RmResource_lockStressObjGetMemoryMappingDescriptor,    // virtual inherited (rmres) base (gpures)
    ...
    .vtable.__lockStressObjControlSerialization_Prologue__ = &__nvoc_up_thunk_RmResource_lockStressObjControlSerialization_Prologue,    // virtual inherited (rmres) base (gpures)
    ...
    .vtable.__lockStressObjControlSerialization_Epilogue__ = &__nvoc_up_thunk_RmResource_lockStressObjControlSerialization_Epilogue,    // virtual inherited (rmres) base (gpures)
    ...
    .vtable.__lockStressObjControl_Prologue__ = &__nvoc_up_thunk_RmResource_lockStressObjControl_Prologue,    // virtual inherited (rmres) base (gpures)
    ...
    .vtable.__lockStressObjControl_Epilogue__ = &__nvoc_up_thunk_RmResource_lockStressObjControl_Epilogue,    // virtual inherited (rmres) base (gpures)
    ...
    .vtable.__lockStressObjCanCopy__ = &__nvoc_up_thunk_RsResource_lockStressObjCanCopy,    // virtual inherited (res) base (gpures)
    ...
    .vtable.__lockStressObjIsDuplicate__ = &__nvoc_up_thunk_RsResource_lockStressObjIsDuplicate,    // virtual inherited (res) base (gpures)
    ...
    .vtable.__lockStressObjPreDestruct__ = &__nvoc_up_thunk_RsResource_lockStressObjPreDestruct,    // virtual inherited (res) base (gpures)
    ...
    .vtable.__lockStressObjControlFilter__ = &__nvoc_up_thunk_RsResource_lockStressObjControlFilter,    // virtual inherited (res) base (gpures)
    ...
    .vtable.__lockStressObjIsPartialUnmapSupported__ = &__nvoc_up_thunk_RsResource_lockStressObjIsPartialUnmapSupported,    // inline virtual inherited (res) base (gpures) body
    ...
    .vtable.__lockStressObjMapTo__ = &__nvoc_up_thunk_RsResource_lockStressObjMapTo,    // virtual inherited (res) base (gpures)
    ...
    .vtable.__lockStressObjUnmapFrom__ = &__nvoc_up_thunk_RsResource_lockStressObjUnmapFrom,    // virtual inherited (res) base (gpures)
    ...
    .vtable.__lockStressObjGetRefCount__ = &__nvoc_up_thunk_RsResource_lockStressObjGetRefCount,    // virtual inherited (res) base (gpures)
    ...
    .vtable.__lockStressObjAddAdditionalDependants__ = &__nvoc_up_thunk_RsResource_lockStressObjAddAdditionalDependants,    // virtual inherited (res) base (gpures)
...
const struct NVOC_CASTINFO __nvoc_castinfo__LockStressObject = {
    .numRelatives = 6,
    .relatives = {
        &__nvoc_metadata__LockStressObject.rtti,    // [0]: (lockStressObj) this
        &__nvoc_metadata__LockStressObject.metadata__GpuResource.rtti,    // [1]: (gpures) super
        &__nvoc_metadata__LockStressObject.metadata__GpuResource.metadata__RmResource.rtti,    // [2]: (rmres) super^2
        &__nvoc_metadata__LockStressObject.metadata__GpuResource.metadata__RmResource.metadata__RsResource.rtti,    // [3]: (res) super^3
        &__nvoc_metadata__LockStressObject.metadata__GpuResource.metadata__RmResource.metadata__RsResource.metadata__Object.rtti,    // [4]: (obj) super^4
        &__nvoc_metadata__LockStressObject.metadata__GpuResource.metadata__RmResource.metadata__RmResourceCommon.rtti,    // [5]: (rmrescmn) super^3
    }
};
...
void __nvoc_init__LockStressObject(LockStressObject *pThis) {
    ...
    pThis->__nvoc_pbase_LockStressObject = pThis;    // (lockStressObj) this

    // Recurse to superclass initialization function(s).
    __nvoc_init__GpuResource(&pThis->__nvoc_base_GpuResource);

    // Pointer(s) to metadata structures(s)
    pThis->__nvoc_base_GpuResource.__nvoc_base_RmResource.__nvoc_base_RsResource.__nvoc_base_Object.__nvoc_metadata_ptr = &__nvoc_metadata__LockStressObject.metadata__GpuResource.metadata__RmResource.metadata__RsResource.metadata__Object;    // (obj) super^4
    pThis->__nvoc_base_GpuResource.__nvoc_base_RmResource.__nvoc_base_RsResource.__nvoc_metadata_ptr = &__nvoc_metadata__LockStressObject.metadata__GpuResource.metadata__RmResource.metadata__RsResource;    // (res) super^3
    pThis->__nvoc_base_GpuResource.__nvoc_base_RmResource.__nvoc_base_RmResourceCommon.__nvoc_metadata_ptr = &__nvoc_metadata__LockStressObject.metadata__GpuResource.metadata__RmResource.metadata__RmResourceCommon;    // (rmrescmn) super^3
    pThis->__nvoc_base_GpuResource.__nvoc_base_RmResource.__nvoc_metadata_ptr = &__nvoc_metadata__LockStressObject.metadata__GpuResource.metadata__RmResource;    // (rmres) super^2
    pThis->__nvoc_base_GpuResource.__nvoc_metadata_ptr = &__nvoc_metadata__LockStressObject.metadata__GpuResource;    // (gpures) super
    pThis->__nvoc_metadata_ptr = &__nvoc_metadata__LockStressObject;    // (lockStressObj) this
