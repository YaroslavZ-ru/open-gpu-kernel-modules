...
// Class-specific details for DeferredApiObject
const struct NVOC_CLASS_DEF __nvoc_class_def_DeferredApiObject = 
{
    .classInfo.size =               sizeof(DeferredApiObject),
    .classInfo.classId =            classId(DeferredApiObject),
...
// Construct DeferredApiObject object.
...
NV_STATUS __nvoc_ctor_DeferredApiObject(DeferredApiObject *pDeferredApi, RmHalspecOwner *pRmhalspecowner, struct CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams) {    // inline
    NV_STATUS status = NV_OK;

    // Recurse to ancestor constructor(s).
    status = __nvoc_ctor_ChannelDescendant(&pDeferredApi->__nvoc_base_ChannelDescendant, pRmhalspecowner, pCallContext, pParams, ((void *)0));
    if (status != NV_OK) goto __nvoc_ctor_DeferredApiObject_fail_ChannelDescendant;

    // Initialize data fields.
    __nvoc_init_dataField_DeferredApiObject(pDeferredApi);

    // Call the constructor for this class.
    status = __nvoc_defapiConstruct(pDeferredApi, pCallContext, pParams);
...
NV_STATUS __nvoc_objCreate_DeferredApiObject(DeferredApiObject **__nvoc_ppThis, Dynamic *__nvoc_pParent, NvU32 __nvoc_createFlags, struct CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams)
{
    NV_STATUS __nvoc_status;
    Object *__nvoc_pParentObj = NULL;
    DeferredApiObject *__nvoc_pThis;
    ...
    {
        __nvoc_pThis = portMemAllocNonPaged(sizeof(DeferredApiObject));
        NV_CHECK_OR_RETURN(LEVEL_ERROR, __nvoc_pThis != NULL, NV_ERR_NO_MEMORY);
    }

    // Zero is the initial value for everything.
    portMemSet(__nvoc_pThis, 0, sizeof(DeferredApiObject));
    ...
    NV_CHECK_TRUE_OR_GOTO(__nvoc_status, LEVEL_ERROR, __nvoc_pParent != NULL, NV_ERR_INVALID_ARGUMENT, __nvoc_objCreate_DeferredApiObject_cleanup);
    ...
    NV_CHECK_TRUE_OR_GOTO(__nvoc_status, LEVEL_ERROR, pRmhalspecowner != NULL, NV_ERR_INVALID_ARGUMENT, __nvoc_objCreate_DeferredApiObject_cleanup);

    // Initialize vtable, RTTI, etc., then call constructor.
    __nvoc_init__DeferredApiObject(__nvoc_pThis, pRmhalspecowner);
    __nvoc_status = __nvoc_ctor_DeferredApiObject(__nvoc_pThis, pRmhalspecowner, pCallContext, pParams);
    if (__nvoc_status != NV_OK) goto __nvoc_objCreate_DeferredApiObject_cleanup;
