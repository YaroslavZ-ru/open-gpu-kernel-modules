...
// Class-specific details for SyncGpuBoost
const struct NVOC_CLASS_DEF __nvoc_class_def_SyncGpuBoost = 
{
    .classInfo.size =               sizeof(SyncGpuBoost),
    .classInfo.classId =            classId(SyncGpuBoost),
...
NV_STATUS __nvoc_ctor_SyncGpuBoost(SyncGpuBoost *pResource, struct CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams) {    // inline
    ...
    __nvoc_init_dataField_SyncGpuBoost(pResource);

    // Call the constructor for this class.
    status = __nvoc_syncgpuboostConstruct(pResource, pCallContext, pParams);
...
NV_STATUS __nvoc_objCreate_SyncGpuBoost(SyncGpuBoost **__nvoc_ppThis, Dynamic *__nvoc_pParent, NvU32 __nvoc_createFlags, struct CALL_CONTEXT *pCallContext, struct RS_RES_ALLOC_PARAMS_INTERNAL *pParams)
{
    NV_STATUS __nvoc_status;
    Object *__nvoc_pParentObj = NULL;
    SyncGpuBoost *__nvoc_pThis;
    ...
    {
        __nvoc_pThis = portMemAllocNonPaged(sizeof(SyncGpuBoost));
        NV_CHECK_OR_RETURN(LEVEL_ERROR, __nvoc_pThis != NULL, NV_ERR_NO_MEMORY);
    }

    // Zero is the initial value for everything.
    portMemSet(__nvoc_pThis, 0, sizeof(SyncGpuBoost));
    ...
    __nvoc_init__SyncGpuBoost(__nvoc_pThis);
    __nvoc_status = __nvoc_ctor_SyncGpuBoost(__nvoc_pThis, pCallContext, pParams);
    if (__nvoc_status != NV_OK) goto __nvoc_objCreate_SyncGpuBoost_cleanup;
