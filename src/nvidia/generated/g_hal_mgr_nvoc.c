...
// Class-specific details for OBJHALMGR
const struct NVOC_CLASS_DEF __nvoc_class_def_OBJHALMGR = 
{
    .classInfo.size =               sizeof(OBJHALMGR),
    .classInfo.classId =            classId(OBJHALMGR),
    .classInfo.providerId =         &__nvoc_rtti_provider,
#if NV_PRINTF_STRINGS_ALLOWED
    .classInfo.name =               "OBJHALMGR",
#endif
...
// Destruct OBJHALMGR object.
void __nvoc_halmgrDestruct(OBJHALMGR*);
...
// Construct OBJHALMGR object.
NV_STATUS __nvoc_ctor_Object(Object *);
NV_STATUS __nvoc_ctor_OBJHALMGR(OBJHALMGR *arg_this) {
    ...
    __nvoc_init_dataField_OBJHALMGR(arg_this);

    // Call the constructor for this class.
    status = __nvoc_halmgrConstruct(arg_this);
...
NV_STATUS __nvoc_objCreate_OBJHALMGR(OBJHALMGR **__nvoc_ppThis, Dynamic *__nvoc_pParent, NvU32 __nvoc_createFlags)
{
    NV_STATUS __nvoc_status;
    Object *__nvoc_pParentObj = NULL;
    OBJHALMGR *__nvoc_pThis;
    ...
    {
        __nvoc_pThis = portMemAllocNonPaged(sizeof(OBJHALMGR));
        NV_CHECK_OR_RETURN(LEVEL_ERROR, __nvoc_pThis != NULL, NV_ERR_NO_MEMORY);
    }

    // Zero is the initial value for everything.
    portMemSet(__nvoc_pThis, 0, sizeof(OBJHALMGR));
    ...
    __nvoc_init__OBJHALMGR(__nvoc_pThis);
    __nvoc_status = __nvoc_ctor_OBJHALMGR(__nvoc_pThis);
    if (__nvoc_status != NV_OK) goto __nvoc_objCreate_OBJHALMGR_cleanup;
...
NV_STATUS __nvoc_objCreateDynamic_OBJHALMGR(OBJHALMGR **__nvoc_ppThis, Dynamic *__nvoc_pParent, NvU32 __nvoc_createFlags, va_list __nvoc_args) {
    NV_STATUS __nvoc_status;

    __nvoc_status = __nvoc_objCreate_OBJHALMGR(__nvoc_ppThis, __nvoc_pParent, __nvoc_createFlags);
